...
import { generateRandomVerificationCode } from "../../register/utils/validations/generateRandomVerificationCode";
 ...
 */
export const createOrUpdateVerificationEntry = async (userId: number): Promise<string> => {
